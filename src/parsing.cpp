...
using hmp::token;
using hmp::token_type;

using hmp::AST_Node;
using hmp::AST_String;
using hmp::AST_Integer;
using hmp::AST_Float;
using hmp::AST_Void;
using hmp::AST_GlobalCall;
using hmp::AST_LinearList;
using hmp::AST_PropertyList;
...
int hmp::parse_tokens(std::vector<hmp::token> const& tokens, std::unique_ptr<hmp::AST_Node>& result) {
