...
AST_GlobalCall::AST_GlobalCall(std::string const& name) : name(name), arguments(std::vector<std::unique_ptr<hmp::AST_Node>>()) {}
AST_GlobalCall::AST_GlobalCall(std::string&& name) : name(std::move(name)), arguments(std::vector<std::unique_ptr<hmp::AST_Node>>()) {}
...
AST_LinearList::AST_LinearList() : elements(std::vector<std::unique_ptr<hmp::AST_Node>>()) {}
